...
列表的索引和切片操作与字符串完全相同（0-based，支持负索引，切片返回新列表）。
...
print(fruits)       # ["apple", "kiwi", "peach", "grape", "mango"]
...
# 通过切片删除元素
fruits[1:3] = []    # 删除索引1~2的元素
print(fruits)       # ["apple", "peach", "grape", "mango"]
```
